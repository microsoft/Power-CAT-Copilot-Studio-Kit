...
export const COMPLIANCE_CRITERIA: readonly ComplianceCriterion[] = [
...
export const SEVERITY_POINTS: Record<'High' | 'Medium' | 'Low', number> = {
  High: 3,
  Medium: 2,
  Low: 1,
};
...
export const MAX_INSTRUCTION_POINTS = COMPLIANCE_CRITERIA.reduce(
  (sum, c) => sum + SEVERITY_POINTS[c.inherentSeverity],
  0
);
