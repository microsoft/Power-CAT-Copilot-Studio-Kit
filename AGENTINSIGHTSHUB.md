# Agent Insights Hub - Complete Documentation

> **Version:** 1.1.4  
> **Last Updated:** January 2026  
> **Part of:** Copilot Studio Kit
...
**Agent Insights Hub** is a Power Apps Code Component that bridges the gap between Azure Application Insights telemetry and enterprise Power Platform capabilities. It provides:

| Capability | Description |
|------------|-------------|
| **365+ Day Retention** | Store historical metrics in Dataverse without extra Azure costs |
| **Unified Cross-Agent View** | Single dashboard across all workspaces, environments, and agents |
| **No Azure Access Required** | Business users view analytics in Power Apps without Azure portal access |
| **Privacy-Safe Access** | Users view aggregates only; no access to message content or PII |
| **Flexible Reporting** | Connect to Power BI, export to Excel, or analyze with Copilot/AI tools |
...
| KPI | Description | Calculation |
|-----|-------------|-------------|
| **Query Count** | GenAI requests | Count of SearchAndSummarize calls |
| **Success Rate** | Reliability | Successful responses percentage |
| **Avg Response Time** | Generation speed | Mean time for AI response |
| **Token Usage** | Resource consumption | Tokens used for responses |
...
| [Import_GenAIMetrics.kql](../../../Import%20Queries/Import_GenAIMetrics.kql) | `cat_genaimetrics` | date + agent + knowledgeSource + channel + dataSource |
...
|-------|--------------|---------|
| `cat_copilotconfiguration` | Copilot Configuration | Agent settings and Azure credentials |
...
| `cat_genaimetrics` | GenAI Metrics | Generative AI usage data |
...
*Document generated for Agent Insights Hub v1.1.4*
