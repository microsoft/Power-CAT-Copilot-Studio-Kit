"""Regenerate mcp-tools.json + ai-plugin.json from the live SF server.
...
# Ensure the app root is on sys.path so sf_crm_mcp is importable
...
SERVER_PATH    = "/mcp"
TOOL_PREFIX    = "sf__"
TUNNEL_BASE    = os.getenv("MCP_GATEWAY_URL", "https://localhost:8080")
...
def main() -> int:
    entries, functions = build_entries(sf)
