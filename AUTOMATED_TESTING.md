...
- Run Automated Tests: The flow pauses the deployment, runs automated tests, evaluates test results, and decides whether to proceed with deployment based on the test outcomes. See [Scheduled Testing](./CONFIGURE_COPILOTS.md#scheduled-testing) for configuration details.
